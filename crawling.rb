...
@build_data = search[17].text                        #건물 건축일
...
# page8 = page.link_with(:text => '평가인증').click
# search = page8.search("td")

# puts 

# page.search("#crname").last.set_attribute("value","abc")

# page.search("#sfrm > div > div > div.option_con2 > a").last.set_attribute("class","lsh");
# page.search("#content > div.conArea > ul > li:nth-child(3) > a").last.set_attribute("class","lsh")

# page2 = page.at(".lsh").click
# page2 = page.link_with(:dom_class => 'lsh').click
# page2 = page.link_with(:dom_class => 'lsh').click
# page2 = page.link_with(:text => '검색').click
# page2 = page.link_with(text: "유치원 검색").click

# puts next_page

# puts page2.uri
# puts page.search("#content > div.conArea > ul > li:nth-child(3) > a").first
# puts page2.class
# puts page.at(".lsh").class
# puts page.search("#sfrm > div > div > div.option_con2 > a").last
# puts page2.search("#divListArea > div > table > tbody > tr:nth-child(1) > td.td_left > a:nth-child(1)").first.class
# puts page2.search("#divListArea > div > table > tbody > tr:nth-child(1)")
# puts page.search("#crname").last
# puts page.search("input").last.class
# puts page.link_with(:dom_class => 'lsh').class
# puts page.link_with(:text => '검색').click
# puts page.link_with(:text => '검색').class